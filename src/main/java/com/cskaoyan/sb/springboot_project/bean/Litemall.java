...
public class Litemall {
    ...
    public Litemall(String cskaoyan_mall_mall_address, String cskaoyan_mall_mall_name, String cskaoyan_mall_mall_phone, String cskaoyan_mall_mall_qq) {
